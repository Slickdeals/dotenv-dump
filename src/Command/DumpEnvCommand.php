...
namespace SD\DotenvDump\Command;

/*
 * This is derived from the Flex DumpEnvCommand and adapted to work without Flex.
 *
...
class DumpEnvCommand extends BaseCommand
{
    ...
    public function __construct(Config $config, string $rootDir)
    {
        $this->config = $config;
...
EOF;
    ...
    {
        // Turning off the errors isn't ideal, but it was required by us
